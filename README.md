...
- 💻 Desenvolvimento de projetos web/mobile com foco em aprendizado prático
- ⚡ Estudo de performance e boas práticas de código
- 🧩 Interesse em arquitetura de software e sistemas escaláveis
- 🔐 Aprendendo sobre APIs, autenticação e segurança
- 🤖 Exploração de automação e integrações
- 📚 Evolução constante em desenvolvimento e tecnologia
